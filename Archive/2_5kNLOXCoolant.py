...
def newton_solve_temperatures(dx, x, y, s, T_LH2, P_LH2, engine_info, 
    ...
    def F(T):
        ...
        q_h2, T_LH2_new, P_LH2_new, dF_dx, h_H2, C3, v, rho_coolant, chan_area, Re, Nu, Dh, therm_LH2, pressureLoss, f, coolant_viscocity, minorLosses, majorLosses, fluidLosses = calc_q_h2(dx, x, y, s, T_cw, T_LH2, P_LH2, engine_info)
...
#     # Initialize arrays with initial conditions for thermal analysis
    ...
    # for i in range(3): # Run for a set number of iterations for now
        ...
        # Store the values for the current x value
            ...
            q_gas,heatflux, h_gas, A_gas, R_hot, areasurface = calc_q_gas(dx, x, y, T_hw, engine_info)
            q_h2, T_coolant, P_coolant, dF_dx_val, h_H2,C3,v, rho_coolant, chan_area, Re, Nu, Dh, therm_LH2, pressureLoss, f, coolant_viscosity,  minorLosses, majorLosses, fluidLosses = calc_q_h2(dx, x, y, s, T_cw, T_coolant, P_coolant, engine_info) # Calculate heat transfer through coolant channels
            q_wall = calc_q_wall(dx, x, y, T_hw, T_cw, engine_info) # Calculate heat transfer through the wall
            ...
            rho_coolant_array[i] = rho_coolant # Store the density of liquid hydrogen in [kg/m^3]
