...
# Used to calculate the specific gas constant of a mixture (R/M where R is the universal gas constant and M is the molecular mass of the mixture (mass fraction))

# sum = 0
#     mass_fraction = 0
#     for key, value in combustion_molecules.items():
#         sum = sum + value[0]
#         mass_fraction = mass_fraction + value[0]*value[1]
#         print(f"Molecule: {key} Mole fraction: {value[0]} Molecular mass: {value[1]} [kg/mol] Mass fraction: {value[0]*value[1]}")

#     print(f'Sum of mole fractions: {sum} Mass fraction: {mass_fraction}')
# main()