...
def calculateEnthalpy(T_array,thermoDictionary, b_element, r_element):
    ...
    # thermoDictionary - dictionary containing thermal coefficients a1-5 & b1-2 
    # b_element - thermoDictionary elemental b reference
    # r_element - thermoDictionary elemetnal r reference
    #--------------------------------------------------------------------------------------
    #Outputs
    # h_T - array of enthalpys of length T_array
    #--------------------------------------------------------------------------------------
...
def calculateEntropy(T_array, thermoDictionary, b_element, r_element):
    ...
    #--------------------------------------------------------------------------------------
    #Outputs
    # S_T - array of entropies of length T_array
    #--------------------------------------------------------------------------------------
    bTemp = 1000 # Max temperature before thermal coefficients need to be changed, b for <=1000K & r > 1000K
...
def calculateGibbsEnergy(T_array, h_T, S_T):
    ...
    #--------------------------------------------------------------------------------------
    #Outputs
    # G_T - array of entropies of length T_array
    #--------------------------------------------------------------------------------------
...
thermo_curve_dict = dict("bH2":[2.3443311, 7.9805210E-3, -1.9478000E-5, 2.0157200E-8, -7.3761200E-12, -9.1793517E2, 6.8301024E-1],
